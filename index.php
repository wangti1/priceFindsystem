...
<table width="703" height="151" border="1">
  ...
  <tr>
    <td><?php if ($pageNum_rsdbprice > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_rsdbprice=%d%s", $currentPage, 0, $queryString_rsdbprice); ?>">[第一页]</a>
...
<p>共有<?php echo $totalRows_rsdbprice ?> 笔记录，目前查看第<?php echo ($startRow_rsdbprice + 1) ?>笔至第<?php echo min($startRow_rsdbprice + $maxRows_rsdbprice, $totalRows_rsdbprice) ?>笔</p>
</body>
</html>
<?php
